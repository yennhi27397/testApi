INSERT INTO public.employees (id,last_name,first_name,email,avatar,job_title,department,manager_id,phone,address1,address2,city,state,postal_code,country) VALUES
	 (201,'Harris','George','gharris0@pagesperso-orange.fr','https://robohash.org/modilaboriosammolestiae.bmp?size=50x50&set=set1','Administrative Assistant I','Toys',NULL,'1-(210)270-8536','2 Bayside Drive',NULL,'San Antonio','Texas','78240','United States'),
	 ...
	 (205,'Reynolds','Annie','areynolds4@nasa.gov','https://robohash.org/praesentiumdoloremrerum.png?size=50x50&set=set1','Senior Quality Engineer','Kids',NULL,'1-(775)838-2203','163 Carey Street',NULL,'Reno','Nevada','89550','United States'),
	 (207,'Willis','Willie','wwillis6@berkeley.edu','https://robohash.org/suntsitnecessitatibus.png?size=50x50&set=set1','Structural Analysis Engineer','Shoes',NULL,'1-(317)654-6888','641 Kropf Parkway',NULL,'Indianapolis','Indiana','46216','United States'),
	 (208,'Lawrence','Keith','klawrence7@discovery.com','https://robohash.org/delenitiomnisconsequatur.jpg?size=50x50&set=set1','VP Quality Control','Outdoors',NULL,'1-(501)583-8851','2184 Melby Crossing',NULL,'Little Rock','Arkansas','72222','United States'),
	 (209,'Johnston','Tina','tjohnston8@alexa.com','https://robohash.org/voluptasautmaiores.png?size=50x50&set=set1','Assistant Media Planner','Electronics',NULL,'1-(901)128-9976','72 Hauk Road',NULL,'Memphis','Tennessee','38114','United States'),
	 (210,'Burns','Lisa','lburns9@taobao.com','https://robohash.org/illumsinttempore.jpg?size=50x50&set=set1','Operator','Industrial',NULL,'1-(585)113-8402','99 Manufacturers Drive',NULL,'Rochester','New York','14624','United States'),
	 (211,'Stone','Howard','hstonea@ucsd.edu','https://robohash.org/eautet.bmp?size=50x50&set=set1','Account Executive','Electronics',NULL,'1-(202)958-2516','03 Anthes Center',NULL,'Washington','District of Columbia','20425','United States'),
	 (212,'Brown','Julie','jbrownb@squidoo.com','https://robohash.org/laborumtotameveniet.png?size=50x50&set=set1','Analog Circuit Design manager','Electronics',NULL,'1-(217)741-6449','37574 4th Drive',NULL,'Springfield','Illinois','62705','United States'),
	 (213,'Turner','Edward','eturnerc@theatlantic.com','https://robohash.org/sedutporro.png?size=50x50&set=set1','Structural Engineer','Computers',NULL,'1-(701)353-1996','3 Bultman Circle',NULL,'Fargo','North Dakota','58122','United States');
INSERT INTO public.employees (id,last_name,first_name,email,avatar,job_title,department,manager_id,phone,address1,address2,city,state,postal_code,country) VALUES
	 ...
	 (216,'Hernandez','Kathy','khernandezf@shinystat.com','https://robohash.org/utfaciliset.png?size=50x50&set=set1','Junior Executive','Movies',NULL,'1-(210)733-3380','24 Merrick Way',NULL,'San Antonio','Texas','78225','United States'),
	 ...
	 (219,'Myers','Roger','rmyersi@alexa.com','https://robohash.org/consequaturutquo.png?size=50x50&set=set1','Account Executive','Beauty',NULL,'1-(480)583-9583','3 Eagle Crest Place',NULL,'Gilbert','Arizona','85297','United States');
