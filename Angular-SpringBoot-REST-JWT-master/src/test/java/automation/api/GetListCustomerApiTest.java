...
public class GetListCustomerApiTest {
    ...
    public void GetListCustomerApi_WhenPageIs0AndSizeIs1_ThenReturnData() throws Exception {
        ...
        databaseUtil.executeSQL("cleanUp.sql");
        // prepare data to test.
        databaseUtil.executeSQL("insert_customers_001.sql");
        String response =
            given()
                .queryParam("page", "0")
                .queryParam("size", "1")
        ...
        Assert.assertTrue(CommonUtil.compare(response, "/GetListCustomerApi/GetListCustomerApi_WhenPageIs0AndSizeIs1.json"));
    }
    ...
    public void GetListCustomerApi_WhenPageIs1AndSizeIs1_ThenReturnData() throws Exception {
        ...
        Assert.assertTrue(CommonUtil.compare(response, "/GetListCustomerApi/GetListCustomerApi_WhenPageIs1AndSizeIs1.json"));
    }
    ...
    public void GetListCustomerApi_WhenCustomerID2_ThenReturnData() throws Exception {
        ...
        Assert.assertTrue(CommonUtil.compare(response, "/GetListCustomerApi/GetListCustomerApi_WhenCustomerID2.json"));
    }
    ...
    public void GetListCustomerApi_WhenCustomerID3_ThenReturnData() throws IOException {
        ...
        Assert.assertTrue(CommonUtil.compare(response, "/GetListCustomerApi/GetListCustomerApi_WhenCustomerID3.json"));
    }
    ...
    public void GetListCustomerApi_WhenCustomerID4_ThenReturnEmpty() throws IOException {
        ...
        Assert.assertTrue(CommonUtil.compare(response, "/GetListCustomerApi/GetListCustomerApi_WhenCustomerID4.json"));
    }
    ...
    public void GetListCustomerApi_WhenCompanyIsJetpulse_ThenReturnData() throws IOException {
        ...
        Assert.assertTrue(CommonUtil.compare(response, "/GetListCustomerApi/GetListCustomerApi_WhenCompanyIsJetpulse.json"));
    }
    ...
    public void GetListCustomerApi_WhenCompanyIsAlfredsFutterkiste_ThenReturnEmpty() throws IOException {
        ...
        Assert.assertTrue(CommonUtil.compare(response, "/GetListCustomerApi/GetListCustomerApi_WhenCompanyIsAlfredsFutterkiste.json"));
    }
    ...
    public void GetListCustomerApi_WhenCountryIsUnitedStates_ThenReturnData() throws IOException {
        ...
        Assert.assertTrue(CommonUtil.compare(response, "/GetListCustomerApi/GetListCustomerApi_WhenCountryIsUnitesStates.json"));
    }
    ...
    public void GetListCustomerApi_WhenCountryIsABC_ThenReturnEmpty() throws IOException {
        ...
        Assert.assertTrue(CommonUtil.compare(response, "/GetListCustomerApi/GetListCustomerApi_WhenCountryIsABC.json"));
    }
    @Test
    public void GetListCustomerApi_WhenCustomerIDIsEmpty_ThenReturnData() throws IOException {
        String response =
            given()
                ...
                .statusCode(HttpStatus.SC_OK)
                .extract().asString();
        Assert.assertTrue(CommonUtil.compare(response,"/GetListCustomerApi/GetListCustomerApi_WhenCustomerIDIsEmpty_ThenReturnData.json"));
