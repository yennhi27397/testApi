...
public class DeleteCustomerApiTest {
    ...
    public void deleteCustomerApi_WhenCustomerIDIsExist_ThenDeleteData() throws Exception {
        ...
        Assert.assertTrue(CommonUtil.compare(response, "/DeleteCustomerApi/deleteCustomerApi_WhenCustomerIDIsExist_ThenDeleteData.json"));
    ...
    public void deleteCustomerApi_WhenCustomerIDIsNotExist_ThenRespondNoCustomerExist() throws Exception {
        ...
        Assert.assertTrue(CommonUtil.compare(response, "/DeleteCustomerApi/deleteCustomerApi_WhenCustomerIDIsNotExist_ThenRespondNoCustomerExist.json"));
